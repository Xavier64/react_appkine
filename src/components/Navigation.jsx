...
const Navigation = () => {
    return (
        ...
        <div className='navbar'>
            <ul>
            <NavLink to="/accueil"> <li><img src="img/Home.png" alt="" /></li> </NavLink>
            ...
            <NavLink to="/contact"> <li><img src="img/parametre.png" alt="" /></li> </NavLink>
            <NavLink to="/accueil"> <li><img src="img/deconnexion.png" alt="" /></li> </NavLink>    
            </ul>
        </div>
        </nav>
    );
